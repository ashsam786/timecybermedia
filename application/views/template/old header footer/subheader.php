...
================================================== -->
        ...
        <li class="active"><a href="<?php echo base_url();?>"><i class="fa fa-home"></i>Home</a></li>
		 <li><a href="<?php echo base_url('aboutus');?>">About us</a></li>
          ...
          <ul class="dropdown-menu" stle="background: black; transition: all 0.7s ease-in-out;">
            ...
            <li role="separator" class="divider"></li>
            <li><a href="business">Global Business & Leadership Awards</a></li>
          </ul>
        </li>
  ...
  <section id="page-top" style=" height: 250px;
    background-image: url('http://localhost/assets/images/business_slider.jpg');
    background-size: cover;
    background-repeat: no-repeat;
    background-position: center center;">
      
                   <div class="caption" style="    position: absolute;left: 200px;top: 147px;">
				   <h1 style="color: white;font-size: 42px;font-family: Kaushan Script,Helvetica Neue,Helvetica,Arial,cursive"><?php echo $title?></h1>
				   </div>
        <!-- /carousel -->
    </section>
